                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input class="form-control form-control-sm" id="kode_sparepart" type="text"
                            name="kode_sparepart" value="{{ $detailsparepart->Sparepart->kode_sparepart }}" readonly />
                    </div>
                    <div class="form-group">
                        ...
                        <input class="form-control form-control-sm" id="nama_sparepart" type="text"
                            name="nama_sparepart" value="{{ $detailsparepart->Sparepart->nama_sparepart }}" readonly />
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control form-control-sm" id="id_merk" type="text" name="id_merk"
                                value="{{ $detailsparepart->Sparepart->Merksparepart->merk_sparepart }}" readonly />
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control form-control-sm" id="id_konversi" type="text" name="id_konversi"
                                value="{{ $detailsparepart->Sparepart->Konversi->satuan }}" readonly />
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label class="small mb-1" for="id_rak">Lifetime</label>
                            <input class="form-control form-control-sm" id="id_rak" type="text" name="id_rak"
                                value="{{ $detailsparepart->Sparepart->lifetime }}" readonly />
                        </div>
                        <div class="form-group col-md-6">
                            <label class="small mb-1" for="id_rak">Jenis Barang</label>
                            <input class="form-control form-control-sm" id="id_rak" type="text" name="id_rak"
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control form-control-sm" id="stock_min" type="text" name="stock_min"
                                value="{{ $detailsparepart->qty_stok }}" readonly />
                        </div>
                        <div class="form-group col-md-6">
            ...
            <div class="card mb-4">
                <div class="card card-header-actions">
                    <div class="card-header ">List Gallery
                        <a href="{{ route('gallery.create', $detailsparepart->id_detail_sparepart) }}"
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('gallery.destroy', $item->id_gallery) }}" method="POST" class="d-inline">
                ...
                <div class="modal-body">Apakah Anda Yakin Menghapus Data Foto Sparepart
                    {{ $item->Detailsparepart->nama_sparepart }}?</div>
