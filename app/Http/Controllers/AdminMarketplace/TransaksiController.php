...
class TransaksiController extends Controller
{
    ...
    {
        $transaksi = Transaksi::with('User', 'Detailtransaksi.Sparepart', 'Desa.Kecamatan.Kabupaten.Provinsi')->where('id_bengkel', Auth::user()->id_bengkel)->where('transaksi_status', 'DIBAYAR')->orwhere('transaksi_status', 'DIKIRIM')->orwhere('transaksi_status', 'DITERIMA')->get();
    //    return ($transaksi);
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->back()->with('messageberhasil','Data Berhasil ditambahkan');
    }
}
